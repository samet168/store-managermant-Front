...
const EditOrders = () => {
    ...
    const fetchAll = async () => {
      ...
      try {
        const [custRes, prodRes, orderRes] = await Promise.all([
          api.get('/customer/customers', { headers }),
          api.get('/customer/products',  { headers }),
          api.get(`/customer/orders/${id}`, { headers }),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.post(`/customer/orders/${id}`, form, {
  ...
  return (
    <div className="ao-page">
      ...
      {/* Breadcrumb */}
      <div className="ao-bc">
        <span className="ao-bc-link" onClick={() => navigate('/dashboard/customer/orders')}>Orders</span>
