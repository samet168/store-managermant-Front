...
const AddOrders = () => {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const res = await api.get('/customer/customers', { headers: { Authorization: `Bearer ${token}` } });
    ...
    const fetchProducts = async () => {
      try {
        const res = await api.get('/customer/products', { headers: { Authorization: `Bearer ${token}` } });
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.post('/customer/orders', form, { headers: { Authorization: `Bearer ${token}` } });
  ...
  return (
    <div className="ao-page">
      ...
      <div className="ao-breadcrumb">
        <span className="ao-breadcrumb-link" onClick={() => navigate('/dashboard/customer/orders')}>
          Orders
        </span>
        ...
        <div className="ao-card-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="ao-btn-row">
              ...
              <button type="button" className="ao-btn-cancel" onClick={() => navigate('/dashboard/customer/orders')} disabled={saving}>Cancel</button>
            </div>
          </form>
        </div>
      </div>
