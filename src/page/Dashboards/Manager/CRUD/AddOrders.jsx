...
const AddOrders = () => {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const res = await api.get('/manager/customers', { headers: { Authorization: `Bearer ${token}` } });
    ...
    const fetchProducts = async () => {
      try {
        const res = await api.get('/manager/products', { headers: { Authorization: `Bearer ${token}` } });
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.post('/manager/orders', form, { headers: { Authorization: `Bearer ${token}` } });
      navigate('/dashboard/manager/orders');
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="ao-page">
      ...
      <div className="ao-breadcrumb">
        <span className="ao-breadcrumb-link" onClick={() => navigate('/dashboard/manager/orders')}>
          Orders
        </span>
        ...
        <div className="ao-card-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="ao-btn-row">
              ...
              <button type="button" className="ao-btn-cancel" onClick={() => navigate('/dashboard/manager/orders')} disabled={saving}>Cancel</button>
            </div>
          </form>
        </div>
      </div>
