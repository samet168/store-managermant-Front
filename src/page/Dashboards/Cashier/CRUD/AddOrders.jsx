...
const AddOrders = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await api.post("/cashier/orders", form, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  return (
    <div className="ao-page">
      ...
      <div className="ao-breadcrumb">
        <span
          className="ao-breadcrumb-link"
          onClick={() => navigate("/dashboard/cashier/orders")}
        >
          Orders
        </span>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {total > 0 && (
              ...
              >
                ...
                <span
                  style={{ fontSize: 16, fontWeight: 700, color: "#1d4ed8" }}
                >
                  ${total.toFixed(2)}
                </span>
              </div>
