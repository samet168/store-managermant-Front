...
const Orders = () => {
  ...
  const handleAdd    = ()      => navigate('/dashboard/customer/orders/add');
  // const handleEdit   = (id)    => navigate(`/dashboard/customer/orders/edit/${id}`);
  const handleShow   = (id)    => navigate(`/dashboard/customer/orders/show/${id}`);
